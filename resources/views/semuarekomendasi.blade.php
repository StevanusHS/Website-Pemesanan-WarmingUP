            ...
            <article>
                <div class="relative">
                    ...
                    <div class="absolute top-0 left-0 flex h-full w-full justify-center">
                        <p class="my-auto text-5xl font-semibold text-white pt-11">Menu Rekomendasi</p>
                    </div>
                </div>
            </article>
            <!-- end judul -->
        ...
        <section>
            <article class="w-full h-auto bg-white">
                <div class="block mx-auto max-w-4xl h-auto py-5 bg-white">
                    <div class="flex">
                        <p class="font-semibold text-2xl mx-10 mb-3 mt-3">Semua menu rekomendasi</p>
                    </div>
                    <!-- card bento -->
                    <div class="flex justify-center">
                        <div class="grid grid-cols-4 gap-5">
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/nasgor/nasigorengtelur.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/nasgor/miegorengjowo.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                                <div class="py-2 flex flex-col justify-between bg-white h-40">
                                    <div class="w-full h-auto bg-white ">
                                        <a href="#">
                                            <div class="flex justify-between">
                                                <p class="font-normal px-3 text-20">Mie goreng Jowo</p>
                                                <a href="#" class="mx-5 my-1"><i class="fa-regular fa-heart"></i></a>
                                            </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/nasgor/kwetiawgoreng.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
