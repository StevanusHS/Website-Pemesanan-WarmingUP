                ...
                <div class="block mx-auto max-w-4xl h-auto py-5 bg-white">
                    ...
                    <div class="flex justify-center">
                        <div class="grid grid-cols-4 gap-5">
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/teh.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/sekoteng.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                    ...
                    <div class="flex justify-center">
                        ...
                        <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/robustacoco.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/kopisusu.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/gayolatte.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/torajalatte.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/freshmilkchoco.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/coffegayo.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/torajarobusta.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/caddburry.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/milo.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/coklatpanas.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/melonlemonade.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/tehtarik.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/thaimatcha.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/softdrink.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/torabikacappucinno.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/jahehangat.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/kopigilusindocafe.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/nutrisari.jpg') }} alt="card-food" class="rounded-t-lg h-[135px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
