                    ...
                    <div class="flex justify-center">
                        ...
                        <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/nasgor/kwetiawgoreng.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] w-full object-cover">
                                        <div class="w-1/2 h-auto bg-red-500 absolute mx-2 my-2 top-0 left-0 rounded-full">
                                            <p class="font-semibold text-white p-1 items-center text-center">20% off</p>
                                        </div>
                                    </a>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/kopisusuaren.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] w-full object-cover">
                                        <div class="w-1/2 h-auto bg-red-500 absolute mx-2 my-2 top-0 left-0 rounded-full">
                                            <p class="font-semibold text-white p-1 items-center text-center">20% off</p>
                                        </div>
                                    </a>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/minuman/milo.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] w-full object-cover">
                                        <div class="w-1/2 h-auto bg-red-500 absolute mx-2 my-2 top-0 left-0 rounded-full">
                                            <p class="font-semibold text-white p-1 items-center text-center">20% off</p>
                                        </div>
                                    </a>
