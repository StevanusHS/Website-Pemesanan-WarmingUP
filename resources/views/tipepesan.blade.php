            ...
            <article>
                ...
                <div class="container mx-auto">
                    ...
                    <div class="flex justify-center">
                        <button type="submit" class="bg-biru-kode rounded-xl shadow-lg transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 duration-300 hover:bg-blue-800  p-3 px-10 text-white text-xl font-semibold">Simpan</button>
                    </div>
                </div>
            </article>
        </section>
