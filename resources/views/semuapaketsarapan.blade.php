            ...
            <article>
                <div class="relative">
                    ...
                    <div class="absolute top-0 left-0 flex h-full w-full justify-center">
                        <p class="my-auto text-5xl font-semibold text-white pt-11">Paket Sarapan</p>
                    </div>
                </div>
            </article>
            <!-- end judul -->
        ...
        <section>
            <article class="w-full h-auto bg-white">
                <div class="block mx-auto max-w-4xl h-auto py-5 bg-white">
                    <div class="flex">
                        <p class="font-semibold text-2xl mx-10 mb-3 mt-3">Semua menu sarapan</p>
                    </div>
                    <!-- card sarapan -->
                    <div class="flex justify-center">
                        ...
                        <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                            <div class="relative">
                                <a href="#">
                                    <img src={{ URL::asset('/img/paketsarapan/sarapan1.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] w-full object-cover">
                                </a>
                            </div>
                            <div>
                            </div>
                        ...
                        <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                            <div class="relative">
                                <a href="#">
                                    <img src={{ URL::asset('/img/paketsarapan/sarapan2.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] w-full object-cover">
                                </a>
                            </div>
                            <div>
                            </div>
                        ...
                        <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                            <div class="relative">
                                <a href="#">
                                    <img src={{ URL::asset('/img/paketsarapan/sarapan3.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] w-full object-cover">
                                </a>
                            </div>
                            <div>
                            </div>
                        ...
                        <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                            <div class="relative">
                                <a href="#">
                                    <img src={{ URL::asset('/img/paketsarapan/sarapan4.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] w-full object-cover">
                                </a>
                            </div>
                            <div>
                            </div>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/paketsarapan/sarapan5.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                                <div class="py-2 flex flex-col justify-between bg-white h-40">
                                    <div class="w-full h-auto bg-white ">
                                        <a href="#">
                                            <div class="flex justify-between">
                                                <p class="font-normal px-3 text-20">Sarapan 5</p>
                                                <a href="#" class="mx-5 my-1"><i class="fa-regular fa-heart"></i></a>
                                            </div>
                                            <p class="font-semibold px-3 text-sm">Rp15.000</p>
                                        </a>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/paketsarapan/sarapan6.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                                <div class="py-2 flex flex-col justify-between bg-white h-40">
                                    <div class="w-full h-auto bg-white ">
                                        <a href="#">
                                            <div class="flex justify-between">
                                                <p class="font-normal px-3 text-20">Sarapan 6</p>
                                                <a href="#" class="mx-5 my-1"><i class="fa-regular fa-heart"></i></a>
                                            </div>
                                            <p class="font-semibold px-3 text-sm">Rp10.000</p>
                                        </a>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/paketsarapan/sarapan7.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                                <div class="py-2 flex flex-col justify-between bg-white h-40">
                                    <div class="w-full h-auto bg-white ">
                                        <a href="#">
                                            <div class="flex justify-between">
                                                <p class="font-normal px-3 text-20">Sarapan 7</p>
                                                <a href="#" class="mx-5 my-1"><i class="fa-regular fa-heart"></i></a>
                                            </div>
                                            <p class="font-semibold px-3 text-sm">Rp13.000</p>
                                        </a>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/paketsarapan/sarapan8.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                                <div class="py-2 flex flex-col justify-between bg-white h-40">
                                    <div class="w-full h-auto bg-white ">
                                        <a href="#">
                                            <div class="flex justify-between">
                                                <p class="font-normal px-3 text-20">Sarapan 8</p>
                                                <a href="#" class="mx-5 my-1"><i class="fa-regular fa-heart"></i></a>
                                            </div>
                                            <p class="font-semibold px-3 text-sm">Rp13.000</p>
                                        </a>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/paketsarapan/sarapan9.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                                <div class="py-2 flex flex-col justify-between bg-white h-40">
                                    <div class="w-full h-auto bg-white ">
                                        <a href="#">
                                            <div class="flex justify-between">
                                                <p class="font-normal px-3 text-20">Sarapan 9</p>
                                                <a href="#" class="mx-5 my-1"><i class="fa-regular fa-heart"></i></a>
                                            </div>
                                            <p class="font-semibold px-3 text-sm">Rp13.000</p>
                                        </a>
                            ...
                            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                                <div class="relative">
                                    <a href="#">
                                        <img src={{ URL::asset('/img/paketsarapan/sarapan10.jpg') }} alt="card-food" class="rounded-t-lg h-[125px] bg-cover">
                                    </a>
                                </div>
                                <div>
                                </div>
                                <div class="py-2 flex flex-col justify-between bg-white h-40">
                                    <div class="w-full h-auto bg-white ">
                                        <a href="#">
                                            <div class="flex justify-between">
                                                <p class="font-normal px-3 text-20">Sarapan 10</p>
                                                <a href="#" class="mx-5 my-1"><i class="fa-regular fa-heart"></i></a>
                                            </div>
