    ...
    <main>
        ...
        <section>
            <article>
                <div class="max-w-full flex h-80 bg-banner-judul shadow-lg bg-cover">
                    <p class="m-auto text-5xl font-semibold text-white pt-11">Kopi</p>
                </div>
            </article>
            <!-- end judul -->
        </section>
        ...
        <section class="container max-w-full flex justify-center h-auto  bg-white ">
            ...
            <div class="container bg-white h-auto">
                <!-- card menu terlaris -->
                <p class="text-gray-900 text-2xl m-5 font-semibold">Rekomendasi</p>
                ...
                <!-- Menu kopi -->
                <p class="text-gray-900 text-2xl my-5 font-semibold">Menu Kopi</p>
                <div class="grid grid-cols-4 gap-5 ">
                    <div class="max-w-lg bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="rounded-t-lg bg-banner-judul h-40" src="../../public/img/banner.jpg" alt="card">
                    ...
                    <div class="max-w-lg bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            <a href="#" class="flex ">
                                <h5 class="w-full mb-1 text-2xl font-normal tracking-tight text-gray-900 dark:text-white">Mie rebus</h5>
                                <div class="mx-auto my-2"><i class="fa-regular fa-heart"></i></div>
                            </a>
                            <p class="mb-10 font-semibold text-gray-700 dark:text-gray-400">Rp 10.000</p>
                            <div class="flex justify-end items-end">
                    ...
                    <div class="max-w-lg bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            <a href="#" class="flex ">
                                <h5 class="w-full mb-1 text-2xl font-normal tracking-tight text-gray-900 dark:text-white">Mie dokdok</h5>
                                <div class="mx-auto my-2"><i class="fa-regular fa-heart"></i></div>
                            </a>
                            <p class="mb-10 font-semibold text-gray-700 dark:text-gray-400">Rp 17.000</p>
                            <div class="flex justify-end items-end">
                ...
                <p class="text-gray-900 text-2xl my-5 font-semibold">Kopi panas</p>
                <div class="grid grid-cols-4 gap-5 ">
                    <div class="max-w-lg bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="rounded-t-lg bg-banner-judul h-40" src="../../public/img/banner.jpg" alt="card">
